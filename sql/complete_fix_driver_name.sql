-- ============================================================================
-- COMPLETE FIX: Ajouter driver_name et corriger les données
-- ============================================================================
...
-- 3. Recréer la fonction create_fuel_session avec driver_name
...
-- 5. Vérification
SELECT 'driver_name column added' as status;
SELECT COUNT(*) as records_with_driver_name FROM fuel_records WHERE driver_name IS NOT NULL;
