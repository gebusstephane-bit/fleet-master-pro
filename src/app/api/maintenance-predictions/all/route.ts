...
/**
 * GET /api/maintenance-predictions/all
 * Retourne toutes les prédictions urgentes (overdue + due + upcoming) de la company.
 * Lit depuis la table cache `maintenance_predictions`.
 */
